...
--
-- NOTE: This migration was previously commented out and never applied. On fresh
-- DBs it works as-is. On production DBs where these columns were added manually,
-- this migration will fail with "duplicate column" — in that case mark it as
-- applied without running it (`wrangler d1 migrations apply` will skip already-
-- applied migrations once the entry is in d1_migrations).
